...
UCLASS(editinlinenew, meta = (BlueprintSpawnableComponent), ClassGroup = RealSense) class UCameraStreamComponent : public URealSenseComponent
{
	...
	UPROPERTY(BlueprintReadOnly, Category = "RealSense") TArray<int32> DepthBuffer;
